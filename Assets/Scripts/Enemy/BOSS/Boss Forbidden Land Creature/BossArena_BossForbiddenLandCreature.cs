...
public class BossArena_BossForbiddenLandCreature : MonoBehaviour
{
    public Enemy_BossForbiddenLandCreature enemy;
    ...
    private void Update()
    {
        if (enemy == null)
        {
            AudioManager.instance.PlayBGM(0); //play bgm music base game
